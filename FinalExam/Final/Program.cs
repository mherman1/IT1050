namespace Final
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            elevator1.AddOccupant("A1", 180, 0);
            elevator1.AddOccupant("A2", 220, 1);
            bool elevator1IsOverMaxCapacity = elevator1.IsOverMaxCapacity();

            Elevator elevator2 = new Elevator(3, 600);
            elevator2.AddOccupant("A1", 200, 0);
            elevator2.AddOccupant("A2", 200, 1);
            elevator2.AddOccupant("A3", 201, 2);
